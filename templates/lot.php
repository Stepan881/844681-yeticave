...
<div class="page-wrapper">
  ...
  <main>
    ...
    <section class="lot-item container">
      <?php foreach ($lot as $id): ?>
      <h2><?= $id['lot_name']; ?></h2>

      <div class="lot-item__content">
        <div class="lot-item__left">
          <div class="lot-item__image">
            <img src="<?= $id['img']; ?>" width="730" height="548" alt="Сноуборд">
          </div>
          <p class="lot-item__category">Категория: <span><?= $id['category_name']; ?></span></p>
          <p class="lot-item__description"><?= $id['description']; ?></p>
        </div>
